        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form class="form-horizontal" action="{{route('unit.update',['unit' => $unit])}}" method="POST" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <input class="form-control" id="unitName" value="{{$unit->name}}" name="name" placeholder="Enter your unit name" type="text">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                <textarea class="form-control" id="description"  name="description" placeholder="Enter unit Description" type="text">{{$unit->description}}</textarea>
                            </div>
                        </div>
                        <div class="row mb-4">
                            ...
                            <div class="col-md-9">
                                ...
                                <img src="{{asset($unit->image)}}" id="categoryImage" alt="" height="40" width="40">
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <button class="btn btn-primary float-end" type="submit">Update Unit</button>
                    </form>
                </div>
            </div>
        </div>
